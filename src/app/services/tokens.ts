...
import { Activity, Attachment } from "../components/activity-info/activity";
...
export const ServiceToken = {
  ...
  ATTACHMENTS_REPOSITORY: new InjectionToken<AttachmentsRepository<Attachment>>('AttachmentsRepository'),
};